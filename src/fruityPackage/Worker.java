...
public class Worker implements Runnable {
	...
	//Run method for the workers, with assembly lines initialized and assigned they may begin
	public void run() {
		
		//System.out.println(workerThread.getName() + ", GET TO WORK!!!!!!!!!!!!!!!");
		...
		while (getToWork) {
			...
			//Remember that runProcess method also has the validation for processed oranges
			o.runProcess();
	...
	//Waits for worker threads to cease (named differently from other get to stop for diagnostic purposes)
