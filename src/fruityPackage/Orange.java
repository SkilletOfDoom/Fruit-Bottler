...
public class Orange {
	...
	// State of oranges
	public enum State {
		Provided(1), Fetched(2), Peeled(3), Squeezed(4), Bottled(5), QualityAssuranceManned(
				6), Processed(7);
	...
	public void doWork() {
		...
		try {
			...
			System.err
					.println("Incomplete orange processing, juice may be bad");
		}

		// ensures that after time passes oranges have been handled by workers
		// based on task
		state = state.getNext();
